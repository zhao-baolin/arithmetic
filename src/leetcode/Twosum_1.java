...
public class Twosum_1 {
    ...
    /**
     * 暴力法
     * 时间复杂度：O(n^2)O(n2)， 对于每个元素，我们试图通过遍历数组的其余部分来寻找它所对应的目标元素，这将耗费 O(n)的时间。因此时间复杂度为 O(n^2)
     * 空间复杂度：O(1)
     */
    ...
    //注意：如果数组中有一样的值，哈希表将不可用，因为key重复。 所以解题时确认是否会出现重复值。

    public static void main(String[] args) {
        //int[] arr = {8,2,5,9,7,4,6,12,1,10};
        int[] arr = {8,2,5,9,7};
